...
import ParentOnboarding1 from "@/src/components/onboarding/ParentOnboarding1";
import ParentOnboarding2 from "@/src/components/onboarding/ParentOnboarding2";
import ParentOnboarding3 from "@/src/components/onboarding/ParentOnboarding3";
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <ParentOnboarding2 key={"2"} />

        <ParentOnboarding3 key={"3"} />
      </PagerView>
