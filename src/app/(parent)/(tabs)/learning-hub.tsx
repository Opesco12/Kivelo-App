      ...
      <View className="flex-1 px-[15]">
        <View className="h-[160] bg-white rounded-[12] mt-[-35] p-[15] justify-between">
          <View className="flex-row justify-between items-center">
            <View className="">
              <Text className="text-xl">Your Progress</Text>
        ...
        <View className="h-[200] bg-white my-[15] rounded-[12] p-[15]">
          <View className="flex-row items-center gap-[15]">
            ...
            <View>
              ...
              <Text className="text-[#666666]">Try this 5-minute activity</Text>
            </View>
          </View>
        </View>
      </View>
